...
from util.dataloader import yolo_dataset_collate, YoloDataset
...
if __name__ == "__main__":
    # 参数初始化
    annotation_path = 'training_annotation_final.txt'
    ...
    pretrained_dict = torch.load("logs/pre.pth", map_location=device)
